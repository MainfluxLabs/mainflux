...
func (lm *loggingMiddleware) AssignMembers(ctx context.Context, token, orgID string, memberEmails ...string) (err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.AssignMembers(ctx, token, orgID, memberEmails...)
}
