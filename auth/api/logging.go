...
func (lm *loggingMiddleware) InviteOrgMember(ctx context.Context, token, orgID, invRedirectPath string, om auth.OrgMembership) (invite auth.OrgInvite, err error) {
	defer func(begin time.Time) {
