...
| `MF_AUTH_LOGIN_TOKEN_DURATION`   | Access (login) key expiration period                                        | 1h                       |
| `MF_AUTH_REFRESH_TOKEN_DURATION` | Refresh key expiration period; caps how long a session may be renewed     | 168h                     |
...
MF_AUTH_LOGIN_TOKEN_DURATION=[access token duration] \
MF_AUTH_REFRESH_TOKEN_DURATION=[refresh token duration] \
