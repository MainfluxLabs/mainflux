...
func (lm *loggingMiddleware) SelfRegister(ctx context.Context, user users.User, path string) (id string, err error) {
	...
	return lm.svc.SelfRegister(ctx, user, path)
}
...
func (lm *loggingMiddleware) ListUsersByIDs(ctx context.Context, ids []string, email string, order string, dir string, limit uint64, offset uint64) (u users.UserPage, err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.ListUsersByIDs(ctx, ids, email, order, dir, limit, offset)
}
...
func (lm *loggingMiddleware) GenerateResetToken(ctx context.Context, email, path string) (err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.GenerateResetToken(ctx, email, path)
}
...
func (lm *loggingMiddleware) SendPasswordReset(ctx context.Context, path, email, token string) (err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.SendPasswordReset(ctx, path, email, token)
}
