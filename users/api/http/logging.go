...
func (lm *loggingMiddleware) ChangePassword(ctx context.Context, authToken, email, password, oldPassword string) (err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.ChangePassword(ctx, authToken, email, password, oldPassword)
}
