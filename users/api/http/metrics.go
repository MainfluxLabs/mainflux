...
func (ms *metricsMiddleware) CreatePlatformInvite(ctx context.Context, token, redirectPath, email, orgID, role string, groups []auth.GroupInvite) (users.PlatformInvite, error) {
	defer func(begin time.Time) {
