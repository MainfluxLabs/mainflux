...
func newService(db *mongo.Database, dbTracer opentracing.Tracer, ac domainauth.Client, tc protomfx.ThingsServiceClient, logger logger.Logger) readers.Service {
