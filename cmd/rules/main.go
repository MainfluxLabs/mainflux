...
func newService(dbTracer opentracing.Tracer, db *sqlx.DB, tc domain.ThingsClient, nps nats.Publisher, logger logger.Logger, scriptsEnabled bool) rules.Service {
