...
func main() {
	...
	dbTracer, dbCloser := jaeger.Init("timescale", cfg.jaegerURL, logger)
...
func newService(db *sqlx.DB, dbTracer opentracing.Tracer, ac auth.Client, tc protomfx.ThingsServiceClient, logger logger.Logger) readers.Service {
