...
func newService(ac domainauth.Client, tc domainthings.Client, db *sqlx.DB, cache mqttredis.ConnectionCache, dbTracer opentracing.Tracer, logger logger.Logger) mqtt.Service {
	idp := ulid.New()
