...
import (
	...
	"github.com/MainfluxLabs/mainflux/webhooks/events"
...
func newService(ts domain.ThingsClient, dbTracer opentracing.Tracer, db *sqlx.DB, logger logger.Logger, ac domain.AuthClient) webhooks.Service {
