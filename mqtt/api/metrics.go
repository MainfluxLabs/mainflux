...
func (ms *metricsMiddleware) ListSubscriptions(ctx context.Context, profileID, token, key string, pm mqtt.PageMetadata) (mqtt.Page, error) {
	...
	return ms.svc.ListSubscriptions(ctx, profileID, token, key, pm)
}
