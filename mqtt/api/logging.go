...
func (lm *loggingMiddleware) ListSubscriptions(ctx context.Context, profileID, token, key string, pm mqtt.PageMetadata) (page mqtt.Page, err error) {
	...
	return lm.svc.ListSubscriptions(ctx, profileID, token, key, pm)
}
