...
func (lm *loggingMiddleware) ListSubscriptions(ctx context.Context, groupID, token string, key apiutil.ThingKey, pm mqtt.PageMetadata) (page mqtt.Page, err error) {
