...
The service itself is distributed as Docker container. Check the [`timescale-reader`](https://github.com/MainfluxLabs/mainflux/blob/master/docker/addons/timescale-reader/docker-compose.yml) service section in docker-compose to see how service is deployed.
