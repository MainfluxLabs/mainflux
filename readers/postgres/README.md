...
The service itself is distributed as Docker container. Check the [`postgres-reader`](https://github.com/MainfluxLabs/mainflux/blob/master/docker/addons/postgres-reader/docker-compose.yml) service section in 
