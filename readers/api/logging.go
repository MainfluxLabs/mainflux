...
func (lm *loggingMiddleware) ListJSONMessages(ctx context.Context, token string, key domainthings.ThingKey, rpm readers.JSONPageMetadata) (_ readers.JSONMessagesPage, err error) {
...
func (lm *loggingMiddleware) ListSenMLMessages(ctx context.Context, token string, key domainthings.ThingKey, rpm readers.SenMLPageMetadata) (_ readers.SenMLMessagesPage, err error) {
	defer func(begin time.Time) {
