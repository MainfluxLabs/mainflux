...
| `MF_TIMESCALE_WRITER_DB_HOST`          | Timescale DB host                   | timescale-db          |
...
| `MF_TIMESCALE_WRITER_DB`               | Timescale database name             | mainflux              |
...
The service itself is distributed as Docker container. Check the [`timescale-writer`](https://github.com/MainfluxLabs/mainflux/blob/master/docker/addons/timescale-writer/docker-compose.yml) service section in docker-compose to see how service is deployed.
