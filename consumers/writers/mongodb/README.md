...
| `MF_MONGO_WRITER_DB`        | Default MongoDB database name | mainflux              |
...
The service itself is distributed as Docker container. Check the [`mongodb-writer`](https://github.com/MainfluxLabs/mainflux/blob/master/docker/addons/mongodb-writer/docker-compose.yml) service section in docker-compose to see how service is deployed.
