...
| `MF_POSTGRES_WRITER_DB`               | Postgres database name             | mainflux              |
...
The service itself is distributed as Docker container. Check the [`postgres-writer`](https://github.com/MainfluxLabs/mainflux/blob/master/docker/addons/postgres-writer/docker-compose.yml) service section in docker-compose to see how service is deployed.
