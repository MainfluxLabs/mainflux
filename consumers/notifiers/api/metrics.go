...
func (ms *metricsMiddleware) ListNotifiersByGroup(ctx context.Context, token string, groupID string, pm things.PageMetadata) (res things.NotifiersPage, err error) {
	defer func(begin time.Time) {
