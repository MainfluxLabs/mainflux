...
func (nr notifierRepository) RetrieveByGroup(ctx context.Context, groupID string, pm notifiers.PageMetadata) (notifiers.NotifiersPage, error) {
	...
	cq, contactVal := dbutil.GetLikeQuery("contacts", pm.Contact)
