...
func (es eventStore) BackupOrgGroups(ctx context.Context, token string, orgID string) (things.BackupOrgGroups, error) {
	return es.svc.BackupOrgGroups(ctx, token, orgID)
}
