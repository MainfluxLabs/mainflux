...
func TestListThingsByGroup(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			token:   token,
			groupID: grID,
			meta:    things.PageMetadata{PageMetadata: apiutil.PageMetadata{Offset: 0, Limit: thingCount}},
			size:    thingCount,
			err:     nil,
		},
		{
...
func TestListProfilesByGroup(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			token:   token,
			groupID: grID,
			meta:    things.PageMetadata{PageMetadata: apiutil.PageMetadata{Offset: 0, Limit: profileCount}},
			size:    profileCount,
			err:     nil,
		},
		{
