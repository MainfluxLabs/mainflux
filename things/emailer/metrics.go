...
func (ms *metricsMiddleware) SendGroupMembershipNotification(to []string, orgName, groupName, groupRole, redirectPath string) (err error) {
	...
	return ms.emailer.SendGroupMembershipNotification(to, orgName, groupName, groupRole, redirectPath)
}
