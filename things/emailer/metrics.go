...
func (ms *metricsMiddleware) SendGroupMembershipNotification(to []string, orgName, groupName, groupRole, groupLink string) (err error) {
	...
	return ms.emailer.SendGroupMembershipNotification(to, orgName, groupName, groupRole, groupLink)
}
