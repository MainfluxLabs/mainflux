...
type Service interface {
	...
	// SendCommandToThing publishes a command message to the specified thing, authorized by user token.
	...
	SendCommandToThingByKey(ctx context.Context, key things.ThingKey, thingID string, msg protomfx.Message) error
	...
	SendCommandToGroupByKey(ctx context.Context, key things.ThingKey, groupID string, msg protomfx.Message) error
}
