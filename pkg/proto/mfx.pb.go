...
func (m *PubConfByKeyRes) GetProfileID() string {
	if m != nil {
		return m.ProfileID
	}
	return ""
...
func (m *PubConfByKeyRes) GetThingID() string {
	if m != nil {
		return m.ThingID
	}
	return ""
...
var fileDescriptor_4f5c89a6f82d4869 = []byte{
	...
	,
}
