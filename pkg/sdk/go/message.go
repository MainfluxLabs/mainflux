...
func (sdk mfSDK) SendMessage(subtopic, msg string, key domainthings.ThingKey) error {
...
func (sdk mfSDK) ReadMessages(isAdmin bool, pm PageMetadata, keyType, token string) (map[string]any, error) {
	...
	response, err := sdk.sendThingRequest(req, domainthings.ThingKey{Value: token, Type: keyType}, string(sdk.msgContentType))
	if err != nil {
		return nil, err
	}
